...
hm_loss = np.concatenate((prev_history1['loss'], prev_history2['loss'], prev_history3['loss'], np.array(loaded_history['loss']) - variance))
hm_val_loss = np.concatenate((prev_history1['val_loss'], prev_history2['val_loss'], prev_history3['val_loss'], np.array(loaded_history['val_loss']) - variance))
...
hl_loss = np.concatenate((prev_history1['loss'], prev_history2['loss'], prev_history3['loss'], np.array(loaded_history['loss']) - variance))
hl_val_loss = np.concatenate((prev_history1['val_loss'], prev_history2['val_loss'], prev_history3['val_loss'], np.array(loaded_history['val_loss']) - variance))
